...
export const FOOD_DATABASE = [
  ...
  { id: 'xiang_steamed_fish_head', name: '剁椒鱼头', category: '水产', calories: 150, protein: 16.0, carbs: 5.0, fat: 7.0, fiber: 1.0, tags: ['湘菜', '辣'], price: [28, 45] },
  { id: 'xiang_small_fried_pork', name: '小炒肉', category: '肉类', calories: 250, protein: 15.0, carbs: 6.0, fat: 18.0, fiber: 1.0, tags: ['湘菜', '辣'], price: [15, 22] },

  // ============== 川菜扩充 ==============
  { id: 'chuan_saliva_chicken', name: '口水鸡', category: '肉类', calories: 195, protein: 20.0, carbs: 5.0, fat: 11.5, fiber: 0.5, tags: ['川菜', '辣', '凉菜'], price: [22, 35] },
  ...
  { id: 'chuan_steamed_pork', name: '粉蒸肉', category: '肉类', calories: 295, protein: 15.0, carbs: 16.0, fat: 19.0, fiber: 1.0, tags: ['川菜', '家常菜'], price: [22, 35] },
  { id: 'chuan_boiled_beef', name: '水煮牛肉', category: '肉类', calories: 185, protein: 20.0, carbs: 6.0, fat: 9.5, fiber: 1.0, tags: ['川菜', '辣', '高蛋白'], price: [28, 45] },
  { id: 'chuan_dry_fry_beans', name: '干煸四季豆', category: '蔬菜', calories: 110, protein: 4.0, carbs: 14.0, fat: 5.5, fiber: 3.0, tags: ['川菜', '辣', '食堂常见'], price: [10, 16] },
  ...
  { id: 'canteen_braised_egg', name: '卤蛋', category: '蛋奶', calories: 150, protein: 13.0, carbs: 3.0, fat: 9.5, fiber: 0, tags: ['食堂常见', '卤味', '高蛋白'], price: [2, 3] },
  ...
  // ============== 卤味 ==============
  { id: 'lu_duck_neck', name: '卤鸭脖', category: '肉类', calories: 180, protein: 22.0, carbs: 3.0, fat: 9.0, fiber: 0, tags: ['卤味', '辣', '小吃'], price: [8, 15] },
  ...
  { id: 'lu_chicken_leg', name: '卤鸡腿', category: '肉类', calories: 210, protein: 22.0, carbs: 4.0, fat: 12.0, fiber: 0, tags: ['卤味', '高蛋白', '小吃'], price: [10, 18] },
  ...
  { id: 'snack_grilled_sausage', name: '烤肠', category: '零食', calories: 260, protein: 10.0, carbs: 10.0, fat: 20.0, fiber: 0, tags: ['小吃', '烧烤'], price: [4, 8] },
