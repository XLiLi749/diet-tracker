...
export const CANTEEN_RECIPES = {
  breakfast: [
    { items: ['soy_milk', 'meat_bun', 'egg_boiled'], name: '豆浆 + 鲜肉包 + 水煮蛋', canteen: '食堂1楼' },
    { items: ['milk', 'steamed_bun', 'egg_boiled'], name: '牛奶 + 馒头 + 水煮蛋', canteen: '食堂1楼' },
    { items: ['congee', 'egg_fried', 'greens'], name: '白粥 + 煎蛋 + 小菜', canteen: '食堂1楼' },
    { items: ['oatmeal', 'egg_boiled', 'banana'], name: '燕麦粥 + 水煮蛋 + 香蕉', canteen: '食堂2楼' },
    { items: ['soy_milk_sweet', 'youtiao', 'egg_tea'], name: '甜豆浆 + 油条 + 茶叶蛋', canteen: '食堂1楼' },
    { items: ['jianbing', 'milk'], name: '煎饼果子 + 牛奶', canteen: '食堂1楼' },
    { items: ['hand_pancake', 'egg_boiled', 'soy_milk'], name: '手抓饼 + 水煮蛋 + 豆浆', canteen: '食堂2楼' },
    { items: ['millet_congee', 'steamed_bun', 'egg_boiled'], name: '小米粥 + 馒头 + 水煮蛋', canteen: '食堂1楼' },
  ],
  lunch: [
    { items: ['rice_white', 'chicken_leg', 'broccoli'], name: '米饭 + 红烧鸡腿 + 西兰花', canteen: '食堂2楼' },
    { items: ['rice_white', 'chicken_breast', 'greens'], name: '米饭 + 鸡胸肉 + 时蔬', canteen: '食堂2楼' },
    { items: ['rice_white', 'fish_steamed', 'cucumber_salad'], name: '米饭 + 清蒸鱼 + 凉拌黄瓜', canteen: '食堂3楼' },
    { items: ['lamian', 'egg_boiled', 'greens'], name: '兰州拉面 + 时蔬', canteen: '食堂1楼' },
    { items: ['rice_white', 'beef', 'tomato_egg'], name: '米饭 + 牛肉 + 番茄炒蛋', canteen: '食堂3楼' },
    { items: ['rice_white', 'kung_pao_chicken', 'greens'], name: '米饭 + 宫保鸡丁 + 时蔬', canteen: '食堂2楼' },
    { items: ['rice_white', 'mapo_tofu', 'greens'], name: '米饭 + 麻婆豆腐 + 时蔬', canteen: '食堂2楼' },
    { items: ['rice_white', 'fish_sour', 'cucumber'], name: '米饭 + 酸菜鱼 + 黄瓜', canteen: '食堂3楼' },
    { items: ['noodle_fried', 'egg_boiled'], name: '炒面 + 水煮蛋', canteen: '食堂1楼' },
    { items: ['rice_white', 'sweet_sour_pork', 'greens'], name: '米饭 + 糖醋里脊 + 时蔬', canteen: '食堂2楼' },
    { items: ['rice_white', 'potato_shredded', 'egg_boiled'], name: '米饭 + 酸辣土豆丝 + 水煮蛋', canteen: '食堂1楼' },
  ],
  dinner: [
    { items: ['congee', 'fish_steamed', 'cucumber_salad'], name: '杂粮粥 + 清蒸鱼 + 凉拌菜', canteen: '食堂1楼' },
    { items: ['rice_white', 'tofu', 'greens'], name: '米饭 + 麻婆豆腐 + 时蔬', canteen: '食堂2楼' },
    { items: ['sweet_potato', 'chicken_breast', 'broccoli'], name: '红薯 + 鸡胸肉 + 西兰花', canteen: '食堂2楼' },
    { items: ['noodle', 'egg_soup', 'greens'], name: '阳春面 + 蛋花汤 + 小菜', canteen: '食堂1楼' },
    { items: ['millet_congee', 'steamed_bun', 'egg_custard'], name: '小米粥 + 馒头 + 蒸蛋羹', canteen: '食堂1楼' },
    { items: ['rice_white', 'fish_braised', 'greens'], name: '米饭 + 红烧鱼 + 时蔬', canteen: '食堂3楼' },
    { items: ['rice_white', 'eggplant', 'egg_boiled'], name: '米饭 + 红烧茄子 + 水煮蛋', canteen: '食堂2楼' },
    { items: ['zhajiangmian', 'egg_soup'], name: '炸酱面 + 蛋花汤', canteen: '食堂1楼' },
  ],
  snack: [
    { items: ['apple'], name: '苹果 x1', canteen: '超市' },
    { items: ['yogurt'], name: '酸奶 150g', canteen: '超市' },
    { items: ['banana'], name: '香蕉 x1', canteen: '超市' },
    { items: ['orange'], name: '橙子 x1', canteen: '超市' },
    { items: ['milk', 'egg_boiled'], name: '牛奶 + 水煮蛋', canteen: '食堂1楼' },
    { items: ['bread_whole', 'milk_lowfat'], name: '全麦面包 + 低脂牛奶', canteen: '超市' },
    { items: ['grape'], name: '葡萄 150g', canteen: '超市' },
    { items: ['pear'], name: '梨 x1', canteen: '超市' },
    { items: ['almond'], name: '杏仁 15g', canteen: '超市' },
    { items: ['kiwi'], name: '猕猴桃 x1', canteen: '超市' },
  ],
}
