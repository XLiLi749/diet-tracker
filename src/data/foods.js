...
export const FOOD_DATABASE = [
  ...
  // ====== 新增中式面点 ======
  { id: 'redbean_roll', name: '红豆卷', category: '主食', calories: 245, protein: 6.0, carbs: 48.0, fat: 3.5, fiber: 2.0, tags: ['甜口', '早餐', '蒸制'], price: [2, 3] },
  { id: 'plain_roll', name: '原味花卷', category: '主食', calories: 220, protein: 7.0, carbs: 45.0, fat: 2.0, fiber: 1.5, tags: ['早餐', '蒸制'], price: [0.8, 1.5] },
  { id: 'scallion_roll', name: '葱油花卷', category: '主食', calories: 260, protein: 6.5, carbs: 44.0, fat: 7.5, fiber: 1.5, tags: ['早餐', '蒸制', '葱香'], price: [1.5, 2.5] },
  { id: 'radish_bun', name: '萝卜丝包', category: '主食', calories: 195, protein: 6.5, carbs: 32.0, fat: 5.0, fiber: 2.0, tags: ['素食', '早餐', '蒸制'], price: [1.5, 2.5] },
  { id: 'greens_bun', name: '青菜包', category: '主食', calories: 185, protein: 6.0, carbs: 31.0, fat: 4.5, fiber: 2.0, tags: ['素食', '早餐', '蒸制'], price: [1.5, 2.5] },
  { id: 'mushroom_bun', name: '香菇包', category: '主食', calories: 190, protein: 6.5, carbs: 30.0, fat: 5.5, fiber: 2.5, tags: ['素食', '早餐', '蒸制'], price: [2, 3] },
  { id: 'shaomai', name: '烧麦', category: '主食', calories: 230, protein: 7.0, carbs: 35.0, fat: 7.0, fiber: 1.0, tags: ['早餐', '蒸制'], price: [1.5, 3] },
  { id: 'brown_sugar_bun', name: '红糖馒头', category: '主食', calories: 240, protein: 6.5, carbs: 50.0, fat: 1.8, fiber: 1.5, tags: ['甜口', '早餐', '蒸制'], price: [1, 2] },
  { id: 'matuan', name: '麻团', category: '主食', calories: 360, protein: 5.0, carbs: 42.0, fat: 19.0, fiber: 1.5, tags: ['油炸', '早餐', '高热量', '甜口'], price: [2, 4] },
  { id: 'steam_dumpling', name: '蒸饺', category: '主食', calories: 220, protein: 8.5, carbs: 26.0, fat: 8.5, fiber: 1.0, tags: ['早餐', '蒸制'], price: [8, 15] },
  { id: 'pan_fried_dumpling', name: '煎饺', category: '主食', calories: 280, protein: 8.0, carbs: 26.0, fat: 15.0, fiber: 1.0, tags: ['油煎', '早餐'], price: [10, 18] },
  { id: 'chives_pocket', name: '韭菜盒子', category: '主食', calories: 265, protein: 7.5, carbs: 30.0, fat: 13.0, fiber: 2.0, tags: ['油煎', '早餐'], price: [3, 6] },
  { id: 'layered_pancake', name: '千层饼', category: '主食', calories: 310, protein: 6.5, carbs: 40.0, fat: 14.5, fiber: 1.5, tags: ['油煎', '早餐', '葱香'], price: [4, 8] },
  { id: 'plain_bun', name: '包子', category: '主食', calories: 220, protein: 7.5, carbs: 35.0, fat: 5.5, fiber: 1.2, tags: ['早餐', '蒸制'], price: [1.5, 3] },
  { id: 'flour_cake', name: '面饼', category: '主食', calories: 260, protein: 6.5, carbs: 42.0, fat: 7.0, fiber: 1.2, tags: ['早餐', '煎制'], price: [2, 4] },
  { id: 'soup_dumpling', name: '小笼包', category: '主食', calories: 230, protein: 9.0, carbs: 25.0, fat: 9.5, fiber: 0.8, tags: ['早餐', '蒸制', '带汤'], price: [10, 18] },
  { id: 'pan_fried_bun', name: '生煎包', category: '主食', calories: 290, protein: 8.5, carbs: 28.0, fat: 15.5, fiber: 1.0, tags: ['油煎', '早餐'], price: [8, 15] },
  { id: 'guo_tie', name: '锅贴', category: '主食', calories: 270, protein: 8.0, carbs: 27.0, fat: 14.0, fiber: 1.0, tags: ['油煎', '早餐'], price: [10, 18] },
  { id: 'char_siu_bun', name: '叉烧包', category: '主食', calories: 250, protein: 8.0, carbs: 38.0, fat: 7.5, fiber: 1.0, tags: ['早餐', '蒸制', '甜口'], price: [3, 5] },
  { id: 'lava_bun', name: '流沙包', category: '主食', calories: 285, protein: 6.0, carbs: 42.0, fat: 11.0, fiber: 0.8, tags: ['早餐', '蒸制', '甜口', '高热量'], price: [3, 5] },
  { id: 'crystal_shrimp_dumpling', name: '水晶虾饺', category: '主食', calories: 180, protein: 10.0, carbs: 22.0, fat: 5.5, fiber: 0.5, tags: ['蒸制', '茶点'], price: [15, 25] },
  { id: 'sesame_ball', name: '芝麻球', category: '主食', calories: 340, protein: 5.5, carbs: 45.0, fat: 15.5, fiber: 1.8, tags: ['油炸', '甜口', '高热量'], price: [2, 4] },
  { id: 'corn_roll', name: '玉米馒头', category: '主食', calories: 210, protein: 6.0, carbs: 44.0, fat: 1.5, fiber: 2.5, tags: ['早餐', '蒸制', '健康'], price: [1, 2] },
  { id: 'mixed_grain_bun', name: '杂粮包', category: '主食', calories: 200, protein: 6.5, carbs: 40.0, fat: 2.5, fiber: 3.5, tags: ['早餐', '蒸制', '健康', '高纤维'], price: [1.5, 3] },
